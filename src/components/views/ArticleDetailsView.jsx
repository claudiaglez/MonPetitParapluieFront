...
const ArticleDetailsView = ({ articles }) => {
    ...
    const handleEditClick = () => {
        ...
        navigate(`/update/article/${articleDetail.id}`, { state: { article: articleDetail } }); 
    };
    ...
    return (
        ...
        <div className="bg-beige-bg flex justify-center items-center h-screen">
            <div className="max-w-4xl mx-auto flex items-center">
                ...
                />
                <div className="ml-8">
                    <h2 className="text-indigo text-2xl font-bold">{articleDetail.title}</h2>
                    <p className="text-indigo mb-4">{articleDetail.description}</p>
                    <button onClick={handleEditClick} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Editar
          </button>
                </div>
            </div>
