        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-dropdown">
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-indigo dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a
                href="./proyecto"
                className="block py-2 px-3 text-beige-bg bg-beige-bg rounded md:bg-transparent md:text-beige-bg md:p-0 md:dark:text-beige-bg dark:bg-blue-600 md:dark:bg-transparent"
                aria-current="page"
              >
                El Proyecto
              </a>
            ...
            <li className="relative">
              ...
              {isDropdownOpen && (
                <div
                  id="dropdownNavbar"
                  className="absolute mt-2 left-0 z-10 font-normal bg-beige-bg divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600 absolute top-full left-0"
                >
                  <ul
                    className="py-2 text-sm text-indigo dark:text-gray-400"
            ...
            <li>
              <a
                href="./quetebordo"
                className="block py-2 px-3 text-beige-bg rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-beige-bg md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
              >
                ¿Qué te bordo?
              </a>
            </li>
            ...
            <li className="flex items-center">
              <Link to="/form">
                <FaUmbrella
                  className="w-6 h-6 text-beige-bg dark:text-white"
                  aria-hidden="true"
                />
              </Link>
              <svg
                className="w-6 h-6 text-beige-bg dark:text-white ml-2"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
